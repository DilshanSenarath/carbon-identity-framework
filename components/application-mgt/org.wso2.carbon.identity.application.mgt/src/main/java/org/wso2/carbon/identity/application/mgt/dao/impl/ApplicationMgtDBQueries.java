...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_ORACLE = "SELECT ID, APP_NAME, VERSION, " +
            ...
            "(SELECT ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, " +
            "USER_STORE, TENANT_ID, rownum AS rnum FROM " +
            "(SELECT DISTINCT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, " +
            ...
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID DESC) WHERE rownum <= :END_INDEX;" +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_ORACLE = "SELECT ID, APP_NAME, " +
            ...
            "IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
            "ORDER BY ID DESC) WHERE rownum <= :END_INDEX;" +
            ") WHERE rnum > :ZERO_BASED_START_INDEX;";
